...
// a. В каких случаях необходима была явная передача указателя в качестве входных параметров и возвращаемых результатов или в качестве приёмника в методах? - расписала в файле
...
// Думаю, что он смотрит что находится рядом, если справа строка, то он ищет ее среди типов, которые являются зарезервированными словами, а затем среди наименований переменных.
