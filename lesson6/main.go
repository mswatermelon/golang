...
// - Надо проверить число ли a
// - не nil ли b,
// - затем не nil ли *b
// - взять по указетелю значение **b и проверить число ли это
// *** b не возможно, так как всегда между переменными должно быть что-то, иначе это будет новая переменная